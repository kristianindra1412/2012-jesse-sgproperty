...
ALTER TABLE `area` DROP `description`;

ALTER TABLE `rent_sell` DROP `owner_phone`, DROP `owner_email`;

ALTER TABLE `rent_sell` ADD `owner_id` INT NOT NULL AFTER `agent_id`;
